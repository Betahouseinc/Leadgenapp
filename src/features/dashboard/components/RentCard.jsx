...
/**
 * Hero card surfacing the most urgent rent.
 * Gradient color is driven by `derivedStatus`.
 *
 * @param {object}   rent            - Rent record with derivedStatus attached
 * @param {string}   derivedStatus   - "paid" | "upcoming" | "due" | "overdue"
 * @param {Function} onMarkPaid      - (id: number) => void
...
export default function RentCard({ rent, derivedStatus, onMarkPaid, onSendReminder }) {
  ...
  return (
    ...
    >
      {/* Decorative blobs */}
      <div style={{ position: "absolute", top: -35, right: -35, width: 120, height: 120, borderRadius: "50%", background: "rgba(255,255,255,.08)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: -20, left: -20, width: 80,  height: 80,  borderRadius: "50%", background: "rgba(255,255,255,.06)", pointerEvents: "none" }} />
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 4 }}>
        ...
        <span
          style={{
            ...
            borderRadius: 20, backdropFilter: "blur(4px)", marginTop: 4,
          }}
        >
          {cfg.label}
        </span>
